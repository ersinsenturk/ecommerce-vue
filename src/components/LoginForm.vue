<template>
  <div class="relative px-6 py-6 lg:px-8">
    ...
    <Form class="space-y-6" @submit="submitForm" :validation-schema="userSchema">
      ...
      <button
        type="submit"
        class="w-full text-white bg-indigo-500 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
